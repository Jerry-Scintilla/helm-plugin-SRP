const en = {
  ...
  // Dashboard
  'dash.title': 'SRP Dashboard',
  'dash.period.week': 'This Week',
  'dash.period.month': 'This Month',
  'dash.period.quarter': 'This Quarter',
  'dash.period.year': 'This Year',
  'dash.window': 'Window: ',
  'dash.empty': 'No SRP data in this period',
  'dash.card.totalRequests': 'Total Requests',
  'dash.card.totalAmount': 'Total SRP Amount',
  'dash.card.paidAmount': 'Paid Amount',
  'dash.card.approvedAmount': 'Approved Amount',
  'dash.card.totalLoss': 'Total Raw Loss',
  'dash.card.requestsUnit': '',
  'dash.statusBreakdown': 'Status Breakdown',
  'dash.trend.title': 'SRP Trend (Amount / Count)',
  'dash.ships.title': 'Top Ships (Top {n})',
  'dash.chars.title': 'Top Characters (Top {n})',
  'dash.col.rank': '#',
  'dash.col.ship': 'Ship',
  'dash.col.character': 'Character',
  'dash.col.count': 'Count',
  'dash.col.amount': 'SRP Amount',
  'dash.noShips': 'No ship data',
  'dash.noChars': 'No character data',
