...
def upgrade() -> None:
    # srp_status enum — created explicitly, with create_type=False below to stop
    # SQLAlchemy's before_create dispatch from issuing a second CREATE TYPE.
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            PgEnum("pending", "approved", "rejected", "paid", name="srp_status", create_type=False),
            nullable=False,
